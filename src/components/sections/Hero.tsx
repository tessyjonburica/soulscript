    ...
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center pt-32 pb-12 px-6 overflow-hidden bg-[#050505]">
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        <motion.div
          ...
          className="mb-8"
        >
          {/* Logo icon or small text if needed, but screenshot focus is on headline */}
        </motion.div>
        ...
        >
          ...
          <span className="text-primary italic font-light">without losing your brand<br className="hidden md:block" /> voice.</span>
        </motion.h1>
        ...
        >
          <Button variant="primary" size="lg" className="rounded-none bg-[#C1A06E] hover:bg-[#a88b5e] text-black uppercase tracking-[0.2em] text-[11px] font-bold px-12 py-6">
